...
* При запуске при необходимости создастся билд для фронта     
На данный момент для этого в ClientApp должны быть node_modules   
Publish и установку пакетов добавлю позже        
